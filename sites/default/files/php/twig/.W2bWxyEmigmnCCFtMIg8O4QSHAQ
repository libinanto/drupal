...
class __TwigTemplate_3b1c3ba5a7b8a7f3e6740c6ddf20a6d6d7fc3667030ae186b347dca47be846b4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    ...
    {% for item in items %}
      ...
      %}
      {% if menu_level == 0 and item.is_collapsed %}
        <li {{ item.attributes.addClass(item_classes) }}>
        <a href=\"{{ item.url }}\">{{ item.title }} <span class=\"dropdown-arrow\"><i class=\"fa fa-angle-down\" aria-hidden=\"true\"></i></span></a>
  ...
  {% endif %}
{% endmacro %}
", "themes/custom/tara/templates/navigation/menu--main.html.twig", "/var/www/html/drupal/themes/custom/tara/templates/navigation/menu--main.html.twig");
    }
