...
class __TwigTemplate_3a782860ea76f49a40a1fffa21a545af7f0019acaef55d3d980a72357ec57eb9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<header id=\"header\">
  {% if page.header_top or all_icons_show %}
    {% include '@tara/template-parts/header_top.html.twig' %}
  {% endif %}
  <div class=\"header\">
    <div class=\"container\">
      <div class=\"header-container\">
        ...
        {% endif %} <!--/.end if for site_branding -->
        {% if page.search_box or  page.primary_menu %}
          <div class=\"header-right\">
            ...
            {% endif %}<!-- end if for page.primary_menu -->
            {% if page.search_box %}
            ...
            {% endif %} <!-- end if for page.search_box -->
          </div> <!--/.header-right -->
        {% endif %}<!-- end if for page.search_box or  page.primary_menu -->
      </div> <!--/.header-container -->
    </div> <!--/.container -->
  </div><!-- /.header -->
</header>
<!-- End: Header -->
", "@tara/template-parts/header.html.twig", "/var/www/html/drupal/themes/custom/tara/templates/template-parts/header.html.twig");
    }
