...
class __TwigTemplate_af99c70a5655201cdd150fbce6924d60669158dfffa70d020e39249c6034c46d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("{{ attach_library('tara/slider') }}
<section id=\"slider\">
  <div class=\"container\">
    <ul class=\"owl-carousel home-slider\">
      {% if slider_code != '' %}
        {{ slider_code | striptags('<ol>,<ul>,<li>,<p>,<a>,<img>,<video>,<h1>,<h2>,<h3>,<h4>,<h5>,<h6>,<em>,<strong>,<br>,<i>,<div>,<span>,<button>') | raw }}
      {% else %}
      <li>
        <h1>Slider Heading One</h1>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
...
", "@tara/template-parts/slider.html.twig", "/var/www/html/drupal/themes/custom/tara/templates/template-parts/slider.html.twig");
    }
