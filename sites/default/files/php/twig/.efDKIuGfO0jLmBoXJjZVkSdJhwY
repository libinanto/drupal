...
class __TwigTemplate_4b67836d8d24413b5a559db3d8820fb04b73619a553540c40d801e9d25ddbaaf extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<section id=\"last-section\" class=\"section\"></section>
<!-- Start: Footer -->
<footer id=\"footer\" class=\"clear\">
  <div class=\"footer clear\">
    <div class=\"container\">
     ...
     {% if copyright_text or all_icons_show %}
      <section class=\"footer-bottom-middle\">
        ...
        {% endif %} <!-- end if for copyright -->
        {% if all_icons_show %}
          <div class=\"footer-bottom-middle-right\">
            {% include '@tara/template-parts/social-icons.html.twig' %}
          </div>
        {% endif %} <!-- end if for all_icons_show -->
      </section><!-- /footer-bottom-middle -->
     ...
     {% endif %} <!-- end condition for footer_bottom -->
    </div><!-- /.container -->
  </div> <!--/.footer -->
</footer>
{% if scrolltotop_on %}
...
{% endif %}
<!-- End: Footer -->
", "@tara/template-parts/footer.html.twig", "/var/www/html/drupal/themes/custom/tara/templates/template-parts/footer.html.twig");
    }
